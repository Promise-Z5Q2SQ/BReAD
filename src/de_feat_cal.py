...
def de_feat_cal(eeg_data, subject, granularity):
    if os.path.exists(os.path.join('../data/de_feat/', f"{subject}_{granularity}_de.npy")):
        return np.load(os.path.join('../data/de_feat/', f"{subject}_{granularity}_de.npy"))
    else:
        ...
        np.save(os.path.join('../data/de_feat/', f"{subject}_{granularity}_de.npy"), _de_feat)
        return _de_feat
